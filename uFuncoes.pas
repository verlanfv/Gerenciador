...
function Retorna_Pais(pCodigo: String) : String;
...
function RetornaValorTag(pXML : WideString; pTagInicial, pTagFinal : WideString) : WideString;
...
begin
 Tamanho := Length(Valor);
  ...
  begin
    NewValue[I] := System.AnsiChar(Trunc(System.Ord(NewValue[I]) * 2));
  end;
